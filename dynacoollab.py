...
class QdInstrument:
    ...
    def __init__(self, ip_address, remote=True):
        self.qdi_instrument = QDInstrumentFactory.GetQDInstrument(
            'DynaCool', remote, ip_address, DEFAULT_PORT)
    ...
    def getTemperature(self):
        ...
        """
        return self.qdi_instrument.GetTemperature(0., TemperatureStatus(0))
    ...
    def setTemperature(self, temp, rate=10):
        ...
        """
        if 0 <= temp <= 400:
            return self.qdi_instrument.SetTemperature(temp, rate, TemperatureApproach(0))
        else:
...
dyna = QdInstrument('DynaCool', '127.0.0.1', remote=False)
print(dyna.getTemperature()[1])
dyna.setTemperature(290, 10)
print(dyna.getTemperature()[1])